...
#' the sample size `n`.
#'
#' @param p.occ Probability of Occurrence: how big is the probability of the problems that shall be
#'         detected when testing a single user (Nielsen (2000) assumes p.occ = L = 31%).
#' @param d.total Total number of existing (usability) problems in the design
#' @param n Number of subjects
#'
#' @returns
#' Use `d.total = 1` to get a percentage. Otherwise the function returns
#' the number of defects you find with the given sample size.Note that this is
